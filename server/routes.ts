  ...
  app.post("/api/analyze", async (req, res) => {
    try {
      ...
      try {
        ...
        const dialectDict = `九州方言辞書 v0.2（鹿児島・博多・長崎・久留米・北九州 / 整骨院頻出表現）\n【痛み・しびれ】いたか→痛い、いたかばい→痛いよ（久留米）、いたかとー→痛いよ（博多）、いたかっちゃん→痛いんだよ（北九州）、しびれとう→しびれている（博多・久留米）、しびれとっと→しびれている（鹿児島）、しびれっぞ→しびれるぞ（鹿児島）、うっとかー→不快感がある（鹿児島）、うっとうしか→うっとうしい（博多）、ずきずきすっ→ずきずきする（鹿児島）\n【疲労・だるさ】こわい→疲れた・しんどい、こわかー→疲れたなあ（鹿児島・久留米）、こわかとー→疲れているよ（博多）、だるか→だるい、だるかばい→だるいよ（久留米・博多）、だるかとっと→だるいんだよ（鹿児島）、きつか→しんどい・つらい、きつかー→しんどいなあ（鹿児島）、きつかとー→しんどいよ（博多）、よれとう→疲れ果てている（博多・久留米）、へたっとう→力が抜けている（博多）、へたっとっと→力が抜けている（鹿児島）、なおらん→治らない（長崎・北九州）\n【動きにくさ・こわばり】かたか→硬い・動かしにくい、かたかばい→硬いよ（久留米）、かたかとー→硬いよ（博多）、よらん→動けない（鹿児島・久留米）、まがらん→曲がらない、のびらん→伸びない、まわらん→回らない、あがらん→上がらない、ひっぱっとう→引っ張られている感じ（博多）、ひっぱっとっと→引っ張られている（鹿児島）\n【頻度・期間】ずっとばい→ずっとだよ（久留米・博多）、ずっとでごわす→ずっとです（鹿児島）、まえからばい→前からだよ（久留米）、しばらくなっとう→しばらくなっている（博多）、しばらくなっとっと→しばらくなっている（鹿児島）、なんちゃん→何日も・しばらく（鹿児島）、このごろずっと→最近ずっと、きのうからたい→昨日からだよ（北九州）\n【程度】ちーっと→少し（鹿児島）、ちょっとばかし→少しだけ、ぎゃんぎゃん→ひどく・すごく（鹿児島）、なんかこう→なんとなく・うまく言えないが、ぼちぼち→まあまあ・少しずつ（長崎・北九州）、がばい→すごく・とても（佐賀・長崎）、たいぎゃ→とても・大変（北九州・久留米）、ばりばり→とても・すごく（北九州・博多）\n【場所・部位】ここらへん→この辺り、このへんたい→この辺り全体（鹿児島）、うしろっかわ→後ろ側、したっかわ→下側、くびんとこ→首のところ（博多・久留米）、こしんとこ→腰のところ（博多・久留米）\n【相槌・確認】そうばい→そうだよ（久留米・博多）、そうでごわす→そうです（鹿児島）、そうっちゃん→そうなんだよ（北九州）、そうたい→そうだよ（長崎・北九州）、ほんとばい→本当だよ（久留米）、ほんとたい→本当だよ（長崎）、やっぱそうか→やっぱりそうか、あーそうか→ああそうか、よかよか→いいよいいよ・大丈夫`;
...
九州方言辞書 v0.2（鹿児島・博多・長崎・久留米・北九州 / 整骨院頻出表現）
【痛み・しびれ】いたか→痛い、いたかばい→痛いよ（久留米）、いたかとー→痛いよ（博多）、いたかっちゃん→痛いんだよ（北九州）、しびれとう→しびれている（博多・久留米）、しびれとっと→しびれている（鹿児島）、しびれっぞ→しびれるぞ（鹿児島）、うっとかー→不快感がある（鹿児島）、うっとうしか→うっとうしい（博多）、ずきずきすっ→ずきずきする（鹿児島）
【疲労・だるさ】こわい→疲れた・しんどい、こわかー→疲れたなあ（鹿児島・久留米）、こわかとー→疲れているよ（博多）、だるか→だるい、だるかばい→だるいよ（久留米・博多）、だるかとっと→だるいんだよ（鹿児島）、きつか→しんどい・つらい、きつかー→しんどいなあ（鹿児島）、きつかとー→しんどいよ（博多）、よれとう→疲れ果てている（博多・久留米）、へたっとう→力が抜けている（博多）、へたっとっと→力が抜けている（鹿児島）、なおらん→治らない（長崎・北九州）
【動きにくさ・こわばり】かたか→硬い・動かしにくい、かたかばい→硬いよ（久留米）、かたかとー→硬いよ（博多）、よらん→動けない（鹿児島・久留米）、まがらん→曲がらない、のびらん→伸びない、まわらん→回らない、あがらん→上がらない、ひっぱっとう→引っ張られている感じ（博多）、ひっぱっとっと→引っ張られている（鹿児島）
【頻度・期間】ずっとばい→ずっとだよ（久留米・博多）、ずっとでごわす→ずっとです（鹿児島）、まえからばい→前からだよ（久留米）、しばらくなっとう→しばらくなっている（博多）、しばらくなっとっと→しばらくなっている（鹿児島）、なんちゃん→何日も・しばらく（鹿児島）、このごろずっと→最近ずっと、きのうからたい→昨日からだよ（北九州）
